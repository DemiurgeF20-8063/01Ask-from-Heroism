...
***Type***: None
***Damage type***: None
***Comments***: Indestructible. Does not engage in combat.
...
***Type***: Mid Distance
***Damage type***: Bullet
***Comments***: As drop spawns from 10 to 15 Sharpball, 3 to 5 Walker Mine, 2 to 4 Warbot Wrenchman, 1-3 Warbot Shooter, 1-2 Warbot Catapulter, 1 Grable Comdiv. After dropping, it becomes < empty state >, leaves the visible frame, and stops rendering.
